...
TOKEN = '7568351968:AAEhCZeg18_CAYQyIvYJDVE9t9XV5qRrKQ0'
...
FORWARD_CHANNEL_ID = -1002238996151
CHANNEL_ID = -1002238996151
error_channel_id =-1002238996151
...
def handle_message(message):
    ...
    elif message.text == "@JAAT_POWER":
        bot.send_message(message.chat.id, "*@JAAT_POWER*", parse_mode='Markdown')
